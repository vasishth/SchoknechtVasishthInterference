...
###############################################################
## Standard interference model with 4 conditions (but syntactic cue is same clause cue)
###############################################################
model_4cond <- list(
	target_match = list(c(1,1), c(1,1), c(1,1), c(1,1)),
	distractor_match = list(c(0,0), c(0,1), c(0,0), c(0,1)),
	Target = c("Match","Match","Match","Match"),
	Distractor = c("NoMatch","SemMatch","SynMatch","FullMatch"),
