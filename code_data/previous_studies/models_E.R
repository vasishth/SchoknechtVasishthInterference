...
save(m_s_full_precrit, file = paste("model_fits_E/Fit_s_Full_precrit.Rda"))
...
save(m_s_full_crit, file = paste("model_fits_E/Fit_s_Full_crit.Rda"))
...
save(m_s_full_postcrit, file = paste("model_fits_E/Fit_s_Full_postcrit.Rda"))
...
save(m_m_full_precrit, file = paste("model_fits_E/Fit_m_Full_precrit.Rda"))
...
save(m_m_full_crit, file = paste("model_fits_E/Fit_m_Full_crit.Rda"))
...
save(m_m_full_postcrit, file = paste("model_fits_E/Fit_m_Full_postcrit.Rda"))
...
save(m_l_full_precrit, file = paste("model_fits_E/Fit_l_Full_precrit.Rda"))
...
save(m_l_full_crit, file = paste("model_fits_E/Fit_l_Full_crit.Rda"))
...
save(m_l_full_postcrit, file = paste("model_fits_E/Fit_l_Full_postcrit.Rda"))
