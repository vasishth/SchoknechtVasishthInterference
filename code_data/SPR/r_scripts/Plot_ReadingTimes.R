...
p_zoom <- ggplot(data=zoom, aes(x=fake_wordno, y=meanlogrt,
                ...
                geom_point(aes(group = interaction(syntactic.interference, semantic.interference)), size=2, position= position_dodge(0.4)) + 
...
ggsave("Pandora_all_wholesentence_pooled.jpg", width=12, height=7, dpi=600)
