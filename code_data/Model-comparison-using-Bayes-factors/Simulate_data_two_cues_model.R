...
#### Simulate data from the proposal density #####
...
save(simdat_2cues_sameclause,file="Simulated_data_two_cues_model.Rda")
...
save(df.lkl,file="Marginal_likelihood_two_cues_model.Rda")
