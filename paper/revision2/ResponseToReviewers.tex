...
The reviewer seems to believe that our results are not publication-worthy because encoding interference confounded the reading times of all regions after the distractor. However, as we had already discussed in the results of the SPR results, the results of the two published studies using the present design \citep{vandyke07, mertzen} show indications that they were affected by encoding interference as well (see page \pageref{previous_encoding}):
