...
\vskip 1em
with my co-authors Shravan Vasishth and Himanshu Yadav, I would like to submit our second revision of our article titled ``Do syntactic and semantic similarity lead to interference effects? Evidence from self-paced reading and event-related potentials using German''.
...
To address the concern that we overstate the implications of our findings, we have clarified at various places in the abstract and discussion of our results that our findings only apply to the present design. Although we have added clarifying text in this second round of revisions (e.g., regarding the implications, the prolonged reading times starting at the distractor and the use of syntactic and semantic cues), the manuscript length could be shortened by four pages, without compromising on content. We have removed repetitions and have revised unnecessary verbose text passages (e.g., in the description of the SPR results).
We have made our OSF repository public to ensure general accessibility and have updated the link in the manuscript accordingly.
