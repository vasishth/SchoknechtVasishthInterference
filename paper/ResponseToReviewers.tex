...
We have re-done the Figure to reflect our revised modeling. We hope that the scale of the new Figure \ref{fig:model_predictions_ERP} is easier to read:
...
processing, main verb/reduced relative garden paths, predictive
parsing effects, local coherence \textcolor{red}{add refs}. The
...
out as an anomaly; if anything, it's quite the opposite.

\textcolor{red}{add something to paper}
