...
As suggested, we have implemented a null model (no interference), leaving us with a total of three computational models (the null model, the three-cues model by \textcite{mertzen} and our newly proposed two-cues model). We use Bayes factors to quantitatively compare these models. The result of this model comparison is that our new two-cues model outperforms the other two models. We have described the new modeling and model comparisons starting page \pageref{modeling}:
