...
We agree that syntactic interference and/or the interaction could be real, but our data does not provide conclusive evidence for them. Because it can be difficult to discern small differences in the Bayes factor plots (Figures 5 and 11 in Response to E.2), the Table below shows all Bayes factors for syntactic interference and the interaction. All Bayes factors above 1 are highlighted in bold. Following \textcite{jeffreys1998theory} and \textcite{lee2014bayesian}, we regard Bayes factors around 1 as providing no evidence. The only Bayes factor remarkably above 1 is BF$_{10}$ = 2.8 for the syntactic interference effect in the reading times of the spill-over region. Because of the pre-critical effects in the reading times, this effect in the spill-over region is confounded. Therefore, we think that although the Bayes factor theoretically provided anecdotal evidence for syntactic interference in the spill-over region, there is no \textit{decisive} evidence for syntactic interference in our data.
