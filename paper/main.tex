...
We will revisit the absence of syntactic interference in our data in the general discussion.
...
\begin{table}[!htbp]
  ...
  SD & Normal(0, 2)&\\
 \textcolor{blue}{correlations} & \textcolor{blue}{LKJcorr(2)} & & \\
    \bottomrule
    \end{tabular}
\end{table}
...
syntactic &  \textcolor{blue}{-0.16}& \textcolor{blue}{0.08} &  \textcolor{blue}{[-0.33, -0.02]} \\
semantic  &  \textcolor{blue}{-0.30} & \textcolor{blue}{0.10} &  \textcolor{blue}{[-0.50, -0.11]} \\
interaction& \textcolor{blue}{-0.14} & \textcolor{blue}{0.11} &  \textcolor{blue}{[-0.40, -0.01]} \\
    \bottomrule
    \end{tabular}
\end{table}
...
\begin{figure}[H]
    ...
    \centering
    \includegraphics[width=0.7\textwidth]{images/posteriors_eeg.jpg}
\end{figure}
