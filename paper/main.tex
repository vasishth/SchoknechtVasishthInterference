...
\begin{figure}[htpb]
    \caption{Prior and posterior predicted effect sizes on the microvolt scale, i.e., for negative ERPs, for syntactic and semantic interference and their interaction \textcolor{blue}{from three versions of the Lewis and Vasishth (2005) cue-based retrieval mode.}
