...
The absence of (and evidence against) syntactic interference is surprising because the psycholinguistic literature has clearly established that syntactic constraints play a role in sentence processing. For example, \cite{dillon2013} and \cite{Sturt2003} argued that principle A of the binding theory controls the retrieval process in the antecedent-reflexive dependency, effectively eliminating interference from other overlapping features (such as number) of intervening nouns that cannot be an antecedent for the reflexive. For further evidence for this idea from individual differences, see \cite{yadav2021individual}. Even more relevant to the present study is the fact that \cite{mertzen} did find syntactic interference effects. 
