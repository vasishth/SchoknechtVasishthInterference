...
A Bayes factor analysis showed that both the self-paced reading times as well as event-related potentials provided evidence for a semantic interference effect. In the self-paced reading experiment, \textcolor{blue}{semantic interference due to the semantic cue \{+animate\}} caused a reading time slow-down starting at the distractor. 
